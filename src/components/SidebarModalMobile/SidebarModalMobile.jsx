...
const SidebarModalMobile = () => {
  ...
  return (
    <div>
      {matches && <Modal
        open={sidebarModalMobile}
        onClose={handleSidebarModalMobile}
      >
      <Box sx={style}>
            ...
            <ul>
              {categories.map(({ label, value}) => (
                <Link 
                  ...
                  key={value} to="/" 
                  onClick={() => dispatch(selectGenreOrCategory(value)) && handleSidebarModalMobile()}>
              ...
              <ul>
                {data.genres.map(({ name, id }) => (
                  <Link 
                    ...
                    key={id} to="/" 
                    onClick={() => dispatch(selectGenreOrCategory(id)) && handleSidebarModalMobile()}>
...
export default SidebarModalMobile;